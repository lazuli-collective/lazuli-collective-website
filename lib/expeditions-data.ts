...
export const expeditions: Expedition[] = [
  ...
  // Abu Talha, Canyons & Caves
  {
    ...
    crew: [
      ...
      {
        name: "Captain & Crew of M/Y Celesta",
        role: "Vessel Operations",
        bio: "The Celesta's crew brings years of Red Sea liveaboard experience with a specialty in technical diving expedition support. They understand the unique requirements of serious divers and run a tight, professional operation.",
      },
    ],
  },
  {
    ...
    notIncluded: [
      "Technical equipment rentals (stage bottles, twins) and extras available on request",
      "We'll create a custom package tailored to your diving needs and preferences",
    ],
    requirements: [
    ...
    notes: [
      "Exact dates and final pricing are being confirmed—register your interest for priority notification",
      "Itinerary may vary depending on weather and sea conditions",
      "We can assist with the Egypt visa application process",
      "Full trip details and preparation guide will be sent once dates are confirmed",
    ],
    itinerary: [
      {
        day: 1,
