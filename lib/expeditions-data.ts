...
export const expeditions: Expedition[] = [
  {
    ...
    included: [
      ...
      "All technical diving (up to 3 dives per day on dive days)",
      "Twin set, stages, and bailout cylinders provided",
      ...
      "Daily breakfast & lunch at dive center",
      "Airport transfers from Istanbul or Çanakkale",
      "Expert dive guides with 20+ years local experience",
      "Historical briefings with underwater archaeologist",
      "Dive insurance for the duration",
      "Return flights from your home country",
      "All ground transportation",
    ],
    notIncluded: [
      "Personal dive equipment (regs, computers, wing/backplate, drysuit)",
      "CCR unit (bring your own)",
    ...
    requirements: [
      "Technical diving certification: Tec 50 / Advanced Trimix or equivalent for deeper dives",
      "Tec 40 / Intermediate certification minimum for shallower wrecks",
      "CCR divers: appropriate CCR certification to 60m+ recommended",
      "Minimum 100 logged dives, 30+ technical dives",
      "Trimix experience required for dives below 55m",
